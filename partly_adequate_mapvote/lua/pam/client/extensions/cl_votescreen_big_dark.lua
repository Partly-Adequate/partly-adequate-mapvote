...
local map_button_size = 450
local map_image_size = map_button_size - 100
local map_button_label_size = (map_button_size - map_image_size) / 2
local avatar_size = map_button_label_size - 12
local scroll_bar_size = 14
local settings_height = 50
...
surface.CreateFont("PAM_BigNameFont", {
	font = "Trebuchet MS",
	size = map_button_label_size * 0.75
})

surface.CreateFont("PAM_BigPlaycountFont", {
	font = "Trebuchet MS",
	size = map_button_label_size * 0.5
})

surface.CreateFont("PAM_BigCountdownFont", {
	font = "Trebuchet MS",
	size = settings_height - 1
})

surface.CreateFont("PAM_BigSettingsFont", {
	font = "Trebuchet MS",
...
function PANEL:InitCountDown(parent, pos_x, pos_y, width, height)
	...
	lbl_countdown:SetFont("PAM_BigCountdownFont")
...
function PANEL:InitSearchArea(parent, pos_x, pos_y, width, height)
	...
	txt_search:SetFont("PAM_BigSettingsFont")
...
function PANEL:InitSortBox(parent, pos_x, pos_y, width, height)
	...
	cb_sort_by:SetFont("PAM_BigSettingsFont")
...
function PANEL:InitFavorites(parent, pos_x, pos_y, width, height)
	...
	btn_toggle_favorites:SetFont("PAM_BigSettingsFont")
...
function PANEL:InitVotedOn(parent, pos_x, pos_y, width, height)
	...
	btn_toggle_voted_on:SetFont("PAM_BigSettingsFont")
...
function PANEL:InitMapButtons()
	for k, mapinfo in pairs(PAM.maps) do
		...
		lbl_map_name:SetFont("PAM_BigNameFont")
		...
		lbl_playcount:SetFont("PAM_BigPlaycountFont")
...
derma.DefineControl("pam_votescreen_big_dark", "", PANEL, "DFrame")
