local extension = {}
local panel = nil
extension.name = "Medium Dark Votescreen"
extension.is_enabled = false

function extension.OnVoteStarted()
	panel = vgui.Create("pam_votescreen_medium_dark")
end
...
hook.Add("PAM_Register_Client_Extensions", "PAM_Register_Votescreen_Medium_Dark", function()
