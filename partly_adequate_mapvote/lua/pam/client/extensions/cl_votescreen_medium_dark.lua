...
local map_button_size = 225
local map_image_size = map_button_size - 75
...
surface.CreateFont("PAM_MediumNameFont", {
	font = "Trebuchet MS",
	size = map_button_label_size * 0.75
})

surface.CreateFont("PAM_MediumPlaycountFont", {
	font = "Trebuchet MS",
	size = map_button_label_size * 0.5
})

surface.CreateFont("PAM_MediumCountdownFont", {
	font = "Trebuchet MS",
	size = settings_height - 1
})

surface.CreateFont("PAM_MediumSettingsFont", {
	font = "Trebuchet MS",
...
function PANEL:InitCountDown(parent, pos_x, pos_y, width, height)
	...
	lbl_countdown:SetFont("PAM_MediumCountdownFont")
...
function PANEL:InitSearchArea(parent, pos_x, pos_y, width, height)
	...
	txt_search:SetFont("PAM_MediumSettingsFont")
...
function PANEL:InitSortBox(parent, pos_x, pos_y, width, height)
	...
	cb_sort_by:SetFont("PAM_MediumSettingsFont")
...
function PANEL:InitFavorites(parent, pos_x, pos_y, width, height)
	...
	btn_toggle_favorites:SetFont("PAM_MediumSettingsFont")
...
function PANEL:InitVotedOn(parent, pos_x, pos_y, width, height)
	...
	btn_toggle_voted_on:SetFont("PAM_MediumSettingsFont")
...
function PANEL:InitMapButtons()
	for k, mapinfo in pairs(PAM.maps) do
		...
		lbl_map_name:SetFont("PAM_MediumNameFont")
		...
		lbl_playcount:SetFont("PAM_MediumPlaycountFont")
...
derma.DefineControl("pam_votescreen_medium_dark", "", PANEL, "DFrame")
